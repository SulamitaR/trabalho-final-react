...
const QuemSomos = () => {
    ...
    return (
        <center>
            ...
            <body>
                <p>O Serratec – Parque Tecnológico da Região Serrana é uma instituição privada, sem fins lucrativos e de interesse público. Principal indutor de negócios em TI do interior do estado do Rio de Janeiro, o
                    Serratec é também o maior Parque Tecnológico do interior fluminense, abrangendo as cidades de Petrópolis, Teresópolis, Nova Friburgo e Areal. E Nele tem o melhor site de compra/venda e para alugueis de imóveis da
                    da Região serrana</p>
